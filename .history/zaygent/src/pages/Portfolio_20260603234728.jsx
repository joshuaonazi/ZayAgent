          ...
          {PORTFOLIO_HOLDINGS.map(h => (
            <div key={h.token} style={{ display: "grid", gridTemplateColumns: "1fr 80px 100px 80px 100px", gap: 8, padding: "10px 14px", borderBottom: `1px solid ${COLORS.border}`, alignItems: "center" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div style={{ width: 24, height: 24, borderRadius: "50%", background: h.color + "22", border: `1px solid ${h.color}44`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 9, color: h.color, fontWeight: 700 }}>
                  {h.token[0]}
                </div>
