                ...
                onClick={async () => {
                  ...
                  try {
                    await fetch("http://localhost:5000/api/agent/config", {
                      ...
                      body:    JSON.stringify({ riskLevel, maxAllocation: maxAlloc, maxPositions, globalTP, globalSL, scanInterval, enabledChains, autoStable, honeyCheck, liqCheck, dcaLadder, sentimentTrack }),
                    });
                  } catch (err) { console.warn("Config save failed:", err.message); }
