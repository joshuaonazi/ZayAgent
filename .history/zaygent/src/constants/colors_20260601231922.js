export const COLORS = {
  ...
  solana: "#9945ff", bsc: "#f0b90b", eth: "#627eea", near: "#00c08b",
};
...
export const STRATEGIES = [
  ...
  { pair: "ETH/USDT",  strategy: "Scalp Grid",   active: true,  pnl: "+22.5%", chain: "ETH"    },
...
export const MARKET_TOKENS = [
  ...
  { name: "SHIB",   chain: "ETH",    price: "0.00002341",   change: "-1.8%",  vol: "$312M", mcap: "$13B",   up: false },
  { name: "SHIBESTEE",  chain: "ETH",   price: "0.00721",      change: "+44.1%", vol: "$28M",  mcap: "$230M",  up: true  },
];
...
export const PORTFOLIO_HOLDINGS = [
  ...
  { token: "ZEC",   chain: "NEAR",   amount: "18.220",   value: "$1,240.00", pct: 11, color: "#f59e0b" },
  { token: "ETH", chain: "ETH",   amount: "1,820.0",  value: "$219.00",   pct: 2,  color: "#00c08b" },
];

export const HISTORY_SEED = Array.from({ length: 30 }, (_, i) => {
  const chainKeys = ["SOLANA", "BSC", "NEAR", "ETH"];
  const tokenList = ["BONK", "WIF", "PEPE", "FLOKI", "SHIB", "MOG", "SHIBESTEE", "POPCAT"];
