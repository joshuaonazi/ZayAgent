...
export const PORTFOLIO_HOLDINGS = [
  { token: "USDC",  chain: "BASE",   amount: "4,210.00", value: "$4,210.00", pct: 38, color: "#3b82f6" },
  ...
  { token: "BRETT", chain: "BASE",   amount: "1,820.0",  value: "$219.00",   pct: 2,  color: "#00c08b" },
];

export const HISTORY_SEED = Array.from({ length: 30 }, (_, i) => {
  const chainKeys = ["SOLANA", "BSC", "BASE", "NEAR", "ETH"];
