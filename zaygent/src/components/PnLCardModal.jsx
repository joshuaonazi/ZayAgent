...
export default function PnLCardModal({ trade, onClose }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.85)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: 20 }}>
      <div style={{ background: COLORS.bgCard, border: `1px solid ${COLORS.border}`, borderRadius: 12, width: "100%", maxWidth: 820, maxHeight: "90vh", overflow: "auto", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, padding: 20 }}>
          ...
          <div>
            ...
            <div style={{ marginBottom: 16 }}>
              <div style={{ fontSize: 9, color: COLORS.textMuted, letterSpacing: 1, marginBottom: 8 }}>CARD THEME</div>
            ...
            <div style={{ marginBottom: 20 }}>
              <div style={{ fontSize: 9, color: COLORS.textMuted, letterSpacing: 1, marginBottom: 8 }}>SHOW / HIDE</div>
            ...
            {/* Trade Summary */}
            <div style={{ background: COLORS.bg, border: `1px solid ${COLORS.border}`, borderRadius: 8, padding: "12px 14px", marginBottom: 20 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                {[
                  ...
                  { label: "ZEC",       value: trade.zec ? `$${trade.zec}` : "—" },
                ].map(item => (
            ...
            <div style={{ fontSize: 9, color: COLORS.textMuted, textAlign: "center", marginTop: 8, lineHeight: 1.6 }}>
              Card saves as a PNG image you can share on social media
            </div>
          </div>
        </div>
      </div>
